...
<head>
    ...
    <title>
        <?php echo $restaurant['name']; ?> - CampusCravings
    </title>
    <!-- Local CSS only -->
...
<body>
    ...
    <div class="app-container">
        <header class="app-header">
            <a href="home.php" class="back-link-res"> Home</a>

            <div class="logo-desktop">
                Campus<span>Cravings</span></div>
            <div class="account-actions-res">
                <a href="checkout.php" class="back-link-res" title="Cart">Cart</a>
        ...
        <main class="app-main">
            <div class="hero-section hero-section-res">
                <div class="hero-image-container">
                    <div class="hero-bg" style="background-image: url('<?php echo $restaurant['image_url']; ?>');">
                    </div>
            ...
            <div class="search-container" style="padding: 20px; text-align: center;">
                <div class="search-bar search-bar-res" style="margin: 0 auto; max-width: 600px;">
                    <input type="text" id="menuSearchInput" placeholder="Search in menu..." class="search-input-res"
                        onkeyup="filterMenu()">
                </div>
            </div>
...
?>
                ...
                <div class="product-card">
                    ...
                    <div class="card-info">
                        ...
                        <p class="card-desc card-desc-res">
                    ...
                    <button class="add-btn add-btn-res"
    ...
    <script>
        function filterMenu() {
            ...
            cards.forEach(card => {
                ...
                let desc = card.querySelector('.card-desc-res').innerText.toLowerCase();
            ...
            let wrappers = document.querySelectorAll('.category-wrapper-res');
